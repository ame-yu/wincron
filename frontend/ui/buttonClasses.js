...
export const btnPrimaryOutline =
  "appearance-none rounded-xl border-[1.5px] border-blue-600/50 bg-transparent px-2.5 py-2 text-xs font-semibold leading-none text-blue-700 transition hover:border-blue-600/60 hover:bg-blue-50 active:translate-y-px focus:outline-none focus:ring-4 focus:ring-blue-600/20 focus:border-blue-600/60"
...
export const btnIcon = btn + " text-base font-semibold"

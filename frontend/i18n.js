...
const messages = {
  en: {
    ...
    settings: {
      ...
      run_in_tray_help: "Keep running in system tray when closing the window.",
      window: "Window",
    ...
    toast: {
      ...
      copied: "Copied",
      draft_found: "Found an unsaved draft.",
  ...
  zh: {
    ...
    main: {
      ...
      flags: {
        tooltip: {
          CREATE_NEW_CONSOLE: "需要与窗口交互时使用；程序可能抢焦点",
          CREATE_NO_WINDOW: "通常用于静默执行",
          DETACHED_PROCESS: "希望进程不继承父控制台时使用",
        },
      },
      console: {
        allow: "允许显示控制台",
  ...
  ja: {
    ...
    main: {
      ...
      flags: {
        tooltip: {
          CREATE_NEW_CONSOLE: "ウィンドウと対話する必要がある場合に使用します、フォーカスを奪う可能性があります",
      ...
      folders: {
        ...
        delete_confirm: "フォルダ「{name}」を削除しますか？\nタスクは削除されませんが、フォルダ外に移動します。",
      },
      context: {
    ...
    settings: {
      ...
      run_in_tray: "トレイで実行",
      run_in_tray_help: "ウィンドウを閉じたときトレイで実行を継続します。",
      window: "ウィンドウ",
